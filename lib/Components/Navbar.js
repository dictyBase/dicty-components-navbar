...
var Nav = (0, _styles.styled)((0, _react.forwardRef)(function (_ref2, ref) {
  ...
  return _react["default"].createElement("nav", _extends({}, other, {
    ref: ref
  }));
}))({
  display: "flex",
...
function (_Component) {
  ...
  function Navbar() {
    ...
    _this.renderBrand = function () {
      ...
      return _react["default"].createElement(_Brand["default"], {
        title: title,
        href: href
      });
    };
    ...
    _this.renderItems = function () {
      ...
      items = items.map(function (item, i) {
        if (item.element) {
          return _react["default"].cloneElement(item.element, _objectSpread({}, item.element.props, {
            key: i
          }));
