...
var Toggle = _styledComponents2.default.div(_templateObject, '' /* position: fixed; */, '' /* right: ${ props => props.open ? '15px' : '-50px' }; */, '' /* transition: right 0.4s ease; */, '' /* transition: all 0.4s all; */);
